        ...
        <>
            <div className='loader-wrapper flex-col'>
                <div className='loading-container relative'>
                    ...
                    <svg stroke="currentColor" id='svg-sun' fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        <g>
                    ...
                    <svg stroke="currentColor " id='svg-cloud' fill="currentColor" stroke-width="0" viewBox="0 0 640 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        <g>
